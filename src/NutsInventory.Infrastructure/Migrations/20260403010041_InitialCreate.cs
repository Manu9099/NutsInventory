        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    average_price = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sales_metrics", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    discount_applied = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sales_metrics_product_id_month_year",
                table: "sales_metrics",
                columns: new[] { "product_id", "month", "year" },
                unique: true);
        }
